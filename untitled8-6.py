...
def user_input():
    ...
    nutrition_quality = st.number_input('Calidad nutricional', min_value=0.0, max_value=10.0)
    activity_index = st.number_input('Índice de actividad', min_value=0.0, max_value=5.0)
